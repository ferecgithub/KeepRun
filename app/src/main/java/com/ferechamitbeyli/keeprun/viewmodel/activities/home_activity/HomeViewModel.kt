package com.ferechamitbeyli.keeprun.viewmodel.activities.home_activity
...
import com.ferechamitbeyli.keeprun.framework.common.isOnline
...
class HomeViewModel @Inject constructor(
    ...
    private val _eventsChannel = Channel<AuthViewModel.AllEvents>()
    ...
    fun signOut() = viewModelScope.launch {
        try {
            ...
            user?.let {
                _eventsChannel.send(AuthViewModel.AllEvents.Message("Logout Failure"))
            } ?: _eventsChannel.send(AuthViewModel.AllEvents.Message("Sign Out Successful"))
            ...
            _eventsChannel.send(AuthViewModel.AllEvents.Error(error[1]))
        }
    }
